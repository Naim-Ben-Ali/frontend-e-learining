...
public class UserMapper {
    ...
    public void mergeUserInfo(final User user, final ProfileUpdateRequest request) {
        ...
        if (StringUtils.isNotBlank(request.getPhoneNumber()) && !request.getPhoneNumber()
                .equals(user.getPhoneNumber())) {
            user.setPhoneNumber(request.getPhoneNumber());
        }
        if (StringUtils.isNotBlank(request.getProfilePictureUrl()) && !request.getProfilePictureUrl()
                .equals(user.getProfilePictureUrl())) {
